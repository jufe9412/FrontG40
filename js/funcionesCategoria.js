...
function getCategoria(){
    $.ajax({
        url:"http://129.151.120.96:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
...
function postCategoria(){
    ...
    $.ajax({
        url:"http://129.151.120.96:8080/api/Category/save",
        type:"POST",
        datatype:"JSON",
...
function putCategoria(idBotonActualizar){
  ...
  $.ajax({
    url:"http://129.151.120.96:8080/api/Category/update",
    type:"PUT",
    datatype:"JSON",
...
function deleteCategoria(idBotonBorrar){
    Swal.fire({
        ...
        $.ajax({
            url:"http://129.151.120.96:8080/api/Category/"+idBotonBorrar,
            type:"DELETE",
            datatype:"JSON",
